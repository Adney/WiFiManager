...
const char HTTP_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Попытка установить соединение с Wi-FI.<br />Если WI-FI соединение установить не удалось. Подключитесь к точке доступа <span>{v}</span> и попробуйте снова </div>";
